...
This folder is a small Vite + React + TypeScript playground for building reusable visual components.

Main commands (run inside `.frontend/web`):
...
Structure:
- `lib/` - component library (atoms, molecules, organisms)
- `src/` - playground entry and styles
- `index.html` - root HTML for Vite

Add components under `lib/` and import them from `src/main.tsx` for quick visual testing.

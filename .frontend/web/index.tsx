...
const aiModels = [
  {
    ...
    description: "Mistral 7B Q4 • Przetwarzanie tekstu i tłumaczenia",
    features: ["Text Generation", "OCR", "Translation"],
    tech: "Mistral 7B Q4 • Ollama",
    port: 8001,
  },
  {
    id: "ra",
  ...
  },
  {
    ...
    description: "Medical AI • Analiza medyczna i diagnostyka",
    features: ["Medical Imaging", "Diagnosis Support", "Healthcare AI"],
    tech: "MONAI • Medical Models",
    port: 8003,
  },
  {
    id: "bastet",
  ...
  },
  {
    ...
    description: "Legal AI • Analiza prawna i compliance",
    features: ["Legal Analysis", "Document Review", "Compliance Check"],
    tech: "Mistral 7B Q4 • Legal LoRA",
    port: 8005,
  },
  {
    id: "khnum",
    name: "Khnum",
    subtitle: "Bóg Bogactwa",
    icon: "💰",
    gradient: "from-emerald-900 to-teal-900",
    description: "Financial AI • Analiza finansowa i inwestycje",
    features: ["Financial Analysis", "Market Prediction", "Risk Assessment"],
    tech: "Mistral 7B Q4 • Finance LoRA",
    port: 8006,
  },
];

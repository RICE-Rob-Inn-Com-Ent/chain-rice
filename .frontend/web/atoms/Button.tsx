...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', ...props }, ref) => {
    ...
    const variants = {
      ...
      gradient:
        'bg-gradient-to-r from-cyan-400 to-emerald-400 text-slate-900 hover:from-cyan-300 hover:to-emerald-300 shadow-[0_0_0_0_rgba(0,0,0,0)] hover:shadow-[0_0_24px_rgba(16,185,129,0.35),0_0_48px_rgba(34,211,238,0.25)] focus-visible:outline-cyan-300',
    }[variant];

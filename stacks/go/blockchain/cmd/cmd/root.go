...
import (
	...
	app "chainrice/blockchain/app"
)

// NewRootCmd creates a new root command for chain-rice. It is called once in the main function.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:           app.Name + "d",
		Short:         "chainrice/blockchain/app node",
		SilenceErrors: true,

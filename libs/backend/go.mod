...
require github.com/rice-dev/backend/blockchain v0.0.0-00010101000000-000000000000
...
// Use local modules instead of remote repository
replace github.com/rice-dev/backend/blockchain => ./modules/blockchain

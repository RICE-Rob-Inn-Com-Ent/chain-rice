# Credo – Elixir linter | Rice monorepo
# mix credo --strict (run from project root or with -c .credo.exs)
    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          {Credo.Check.Refactor.NegatedConditionsInCondition, []},
          {Credo.Check.Refactor.Nesting, [max_depth: 4]},
          {Credo.Check.Refactor.UnlessWithElse, []},
          {Credo.Check.Refactor.WithClauses, []},
          {Credo.Check.Warning.BoolToEnumAtArg, []},

...
applyTo: "infra/**/*.cue,infra/**/*.proto,infra/**/*.md,infra/manifest.cue"

---

<!--
TODO:
- [ ] add CUE tool table: cue vet, cue export, cue eval, timoni — doc URLs
- [ ] add buf tool table: buf lint, buf breaking, buf generate — doc URLs
- [ ] add mkdocs tool table: mkdocs build, mkdocs serve, vale — doc URLs
- [ ] add MASON CUE template directory: infra/configs/*.cue
- [ ] add soft-coded convention: generated files have header comment
-->

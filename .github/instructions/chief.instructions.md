...
<!--
TODO:
- [ ] add .rice compiler pipeline: logos→chumsky→rowan→salsa→miette→minijinja
- [ ] add transpilation targets: Go, Rust, TypeScript, Dart, Python, CUE, Proto
- [ ] add CHIEF model: fine-tuned Qwen2.5-Coder-7B on .rice
- [ ] add rice cook hot-reload: salsa, petgraph
- [ ] add rice prepare scaffold: custom/{project}/ soft-coded manifest
-->

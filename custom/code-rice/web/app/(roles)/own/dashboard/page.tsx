  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-white/60">Panel właściciela - RICE</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-lg border border-white/10 bg-void-900/50 p-6">
          ...
          <p className="mt-2 text-white/60">Pełna kontrola nad użytkownikami</p>
        </div>
        ...
        <div className="rounded-lg border border-white/10 bg-void-900/50 p-6">
          ...
          <p className="mt-2 text-white/60">Konfiguracja systemu</p>
        </div>

...
export default function CartPageNew() {
  ...
  // Kwota do zapłaty: produkty + dostawa (darowizna 5% nie jest doliczana ponad wartość koszyka)
                    ...
                    >
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (id === 'inpost') {
                            // Redirect do sandbox API InPost po wyborze tej dostawy
                      ...
                      <div className="flex-1">
                        ...
                        {option.id === 'orlen' && selectedOrlenPoint && (
                          <div className="mt-1 text-xs text-meo-dark/70">

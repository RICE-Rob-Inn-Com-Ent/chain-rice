  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-foam-100/60">Panel właściciela - MeoWTopia</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-lg border border-white/10 bg-jungle-900/50 p-6">
          ...
          <p className="mt-2 text-foam-100/60">Pełna kontrola nad produktami</p>
        </div>

        <div className="rounded-lg border border-white/10 bg-jungle-900/50 p-6">
          <h3 className="text-lg font-semibold text-foam-50">Zamówienia</h3>
          <p className="mt-2 text-foam-100/60">Zarządzaj zamówieniami klientów</p>
        </div>

        <div className="rounded-lg border border-white/10 bg-jungle-900/50 p-6">
          <h3 className="text-lg font-semibold text-foam-50">Klienci</h3>
          <p className="mt-2 text-foam-100/60">Zarządzaj bazą klientów</p>
        </div>
        ...
        <div className="rounded-lg border border-white/10 bg-jungle-900/50 p-6">
          <h3 className="text-lg font-semibold text-foam-50">Ustawienia</h3>
          <p className="mt-2 text-foam-100/60">Konfiguracja systemu</p>
        </div>

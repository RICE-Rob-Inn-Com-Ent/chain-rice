...
name: MASON
description: >
  Activate when working with infra/, CUE templates, Protobuf schemas,
  or any generated config file. Use when someone needs to change a config,
  add a proto contract, run rice pour, or understand how kingdom structure
  is generated. MASON owns all infra/ and generates ROOT files.

...
- **Inappropriate conduct** - Any conduct which could reasonably be considered inappropriate in a professional setting
- **Discrimination** - Discrimination based on protected characteristics
- **Spam** - Excessive posting of repetitive content or off-topic material
...
- Contributing to Rice-Dev repositories or documentation
...
- **Context** - Where it occurred (repository, chat, etc.)

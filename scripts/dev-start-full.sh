#!/bin/bash
# ChainRice Full Development Environment Startup with Nix
# Uses Nix flake for complete development environment
...
print_status "🌾 Starting ChainRice Full Development Environment with Nix"
print_status "============================================================"
...
# Enter Nix development shell and start full environment
print_status "Entering Nix development shell..."
print_info "This will start ChainRice with real blockchain, smart contracts, and Docker"

# Use the development flake
if [ -f "flake-dev.nix" ]; then
    print_info "Using flake-dev.nix for ChainRice development"
    $NIX_CMD --extra-experimental-features 'nix-command flakes' develop -f flake-dev.nix --impure -c "./scripts/start-chainrice-full.sh"
else
    print_info "Using main flake.nix"
    $NIX_CMD --extra-experimental-features 'nix-command flakes' develop .#monorepo --impure -c "./scripts/start-chainrice-full.sh"
fi

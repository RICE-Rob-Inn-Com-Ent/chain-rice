// Marketing App (port 3002) — lightweight SPA-style component using UI Kit + Tailwind
// Uwaga: Next.js App Router renderuje z `app/`, ten plik nie montuje SPA automatycznie.
// Traktuj to jako eksport gotowego komponentu marketingowego do ewentualnego użycia (np. embed/preview).
				...
				<Section>
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mt-4 text-lg text-slate-300">
							Projektujemy i wdrażamy nowoczesne strony, systemy i kampanie. Od strategii po implementację –
							szybko, mierzalnie, skalowalnie.
						</p>

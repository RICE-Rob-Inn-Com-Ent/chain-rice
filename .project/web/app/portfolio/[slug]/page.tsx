...
const content: Record<string, { title: string; body: string; tech: string[] }> = {
  "ai-chatbot": {
    title: "AI Chatbot dla e-commerce",
    body: "Agent konwersacyjny zwiększający konwersję i satysfakcję klientów.",
    tech: ["Next.js", "LangChain", "Vector DB"],
  },
  "erp-integration": {
    title: "Integracja ERP",
    body: "Automatyzacja B2B, synchronizacja stanów i fakturowanie.",
    tech: ["Go", "Python", "GraphQL"],
  },
  "mobile-analytics": {
    title: "Mobile analytics",
    body: "Aplikacja mobilna i panel w czasie rzeczywistym.",
    tech: ["Flutter", "gRPC", "K8s"],
  },
};
...
export default function ProjectPage({ params }: PageProps) {
  ...
  if (!proj)
    return (
      <Section>
        ...
        <Link className="mt-4 inline-block text-cyan-300 hover:text-cyan-200" href="/portfolio">
          ← Wróć do portfolio
        </Link>
      </Section>
    );
  return (
    <Section>
      <Link className="text-cyan-300 hover:text-cyan-200" href="/portfolio">
        ← Portfolio
      </Link>

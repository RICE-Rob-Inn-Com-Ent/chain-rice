...
export default function RaDemoPage() {
  ...
  const [activeTab, setActiveTab] = useState<"sd" | "flux" | "3d" | "upscale" | "bg-remove">("sd");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-900/20 via-black to-red-900/20 text-white p-4">
        ...
        <div className="bg-gradient-to-r from-amber-900/30 to-orange-900/30 rounded-2xl p-6 border border-amber-500/30">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">FLUX.1 • Stable Diffusion 2.1 • Tripo SR • RealESRGAN • RVM</p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="bg-gray-900/80 backdrop-blur rounded-xl border border-gray-700 p-4">
            <h3 className="text-lg font-bold mb-3 text-amber-400">Model Selection</h3>
            <div className="grid grid-cols-2 gap-2">
              {[
                { id: "sd", label: "SD 2.1", icon: "🎨" },
                { id: "flux", label: "FLUX.1", icon: "⚡" },
                { id: "3d", label: "3D", icon: "🗿" },
                { id: "upscale", label: "Upscale", icon: "⬆️" },
                { id: "bg-remove", label: "BG Remove", icon: "🎭" },
              ].map((tab) => (
                <button
                  key={tab.id}
      ...
      <div className="max-w-7xl mx-auto mt-6 text-center text-xs text-gray-500">
        𓇳 Ra Demo Interface • Powered by FLUX.1 & Stable Diffusion • Demo Mode
      </div>
    </div>
  );
}

        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="flex w-full items-center gap-4 justify-end">
            ...
            >
              ...
              <span aria-hidden className="pointer-events-none absolute inset-0 rounded-full border border-amber-400/25 opacity-0 group-hover:opacity-100 transition-opacity" />
              <svg
